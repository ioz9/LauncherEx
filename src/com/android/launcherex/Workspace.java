...
public class Workspace extends WidgetSpace implements DropTarget, DragSource, DragScroller {
    ...
    private int mDefaultScreen = Launcher.DEFAULT_SCREEN;
    ...
    private final static int TOUCH_SWIPE_UP_GESTURE = 2;
    private final static int TOUCH_SWIPE_DOWN_GESTURE = 3;
    ...
    void addInScreen(View child, int screen, int x, int y, int spanX, int spanY, boolean insert) {
        if (screen < 0 || screen >= getChildCount()) {
            Log.e(Launcher.LOG_TAG, "The screen must be >= 0 and < " + getChildCount()
    ...
    private void updateWallpaperOffset(int scrollRange) {
        ...
        try {
            ...
            setWallpaperOffsetSteps.invoke(mWallpaperManager, 1.0f / (getChildCount() - 1), 0);
        } catch (Exception e) {
    ...
    public void computeScroll() {
        if (mScroller.computeScrollOffset()) {
            ...
            if (Launcher.enableScreenBounce) setBounceAmount(mScrollingBounce);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        case MotionEvent.ACTION_UP:
            ...
            if (mTouchState == TOUCH_SWIPE_UP_GESTURE )
    ...
    public boolean isWidgetAtLocationScrollable(int x, int y) {
        ...
        Log.d("Workspace", "pointToCellExact : x = " + x + " / y = " +y + " / cellX = " + cell_xy[0] + " / cellY = " + cell_xy[1]);
